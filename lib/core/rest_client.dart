...
class RestClient extends GetxService {
  ...
  static header() => {
        ...
        'Authorization': Utils.AUTH_TOKEN,
      };

  Future<RestClient> init() async {
    _dio = Dio(BaseOptions(baseUrl: Utils.BASE_URL, headers: header(), responseType: ResponseType.plain));
    initInterceptors();
    return this;
  }
  ...
  Future<dynamic> request(
      String url, Method method, {Map<String, dynamic>? params, data}) async {
    Response response;
